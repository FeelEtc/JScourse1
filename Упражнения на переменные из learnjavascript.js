...
alert(num); //всё работает: значение переменной выводится во всплывающем окошке в браузере
...
x += 1; //ПРИМЕР: здесь мы говорим, что к тому выражению, которое уже есть (значение переменной x), мы прибавляем значение, которое находится после знака присваивания (1 в данном случае)
